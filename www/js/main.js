...
$(function () {
    ...
    function updateLight(light, color, transitiontime) {
        light.animate({
    ...
    var flash = function(e) {
        ...
        hueBridge.setGroupState(0, {"ct":153, "transitiontime":0}, function afterFlash() {
            setTimeout(function restore(){
                var lights = $(".light").each(function(light){
                var hue = $(this).data("hue");
                console.log("Restoring "+light+" to hue: ", hue);

                color = jQuery.Color({ hue: hue, saturation: 1.0, lightness: 0.66, alpha:1.0});
                updateLight($(this), color, 0);
                });
            }, 250);
        });
  ...
  return "entity_filled.svg";
        ...
        for (var light in lights) {
           if (lights.hasOwnProperty(light)) {
                ...
                if (state.colormode == "xy") {
                    ...
                    lightcolor = jQuery.Color({ hue: state.hue, saturation: state.sat, lightness: 0.66, alpha: 1.0 });
    ...
    function initLights(bridge) {
        ...
        bridge.getLights(function(lights) {
            ...
            $(".interactionButton").removeClass("ui-disabled");
            $.mobile.loading( "hide" );
